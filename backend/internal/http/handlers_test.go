...
func TestIsValidGitHubName(t *testing.T) {
	cases := []struct {
		...
		{"invalid over 100 characters", "this-is-a-very-long-github-name-that-exceeds-the-maximum-allowed-length-of-one-hundred-characters-which-is-used-to-prevent-dos", false},
	}
